...
exports.CheckIn = (req, res) => {
    ...
    // Cek apakah user sudah check-in hari ini (checkOut masih null)
    ...
    if (existingRecord) {
        return res
            .status(400)
            .json({ message: "Anda sudah melakukan check-in hari ini. Silakan check-out terlebih dahulu." });
    }
    ...
    const newRecord = {
        ...
        checkOut: null, // Masih aktif
    };
    presensiRecords.push(newRecord);

    // Format data untuk respons agar mudah dibaca
    const formattedData = {
        ...newRecord,
...
exports.CheckOut = (req, res) => {
    ...
    // Cari catatan check-in yang aktif (checkOut masih null)

    ...
    return (
        <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-8">
            <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md text-center">
                ...
                {/* --- 4. VISUALISASI PETA (REACT LEAFLET) --- */}
                {coords ? (
                    <div className="my-4 border rounded-lg overflow-hidden">
                        {/* MapContainer harus memiliki center yang valid */}
                        <MapContainer 
                            key={`${coords.lat}-${coords.lng}`} // Key untuk re-render jika koordinat berubah
                        ...
                        >
                            ...
                            />
                            {/* Marker menunjukkan lokasi presensi */}
                ...
                <div className="flex space-x-4 mt-6">
                    <button
                        ...
                        // Nonaktifkan tombol jika lokasi belum didapatkan atau ada error lokasi
                        className="w-full py-3 px-4 bg-green-600 text-white font-semibold rounded-md shadow-sm hover:bg-green-700 disabled:bg-gray-400"
                        disabled={!coords} 
                    >
                        Check-In
                    </button>
